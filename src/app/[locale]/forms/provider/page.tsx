    ...
    <div className="mx-auto w-full max-w-2xl px-4 py-10 sm:py-14">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>{t("forms.provider.subtitle")}</CardDescription>
          <div className="mt-4 rounded-lg border border-white/10 bg-white/[0.02] p-4 text-sm text-muted-foreground">
            <p className="text-foreground/90 font-medium">{t("forms.provider.pitchTitle")}</p>
            <ul className="mt-2 list-disc ps-5 space-y-1">
              <li>{t("forms.provider.pitchBullet0")}</li>
              <li>{t("forms.provider.pitchBullet1")}</li>
              <li>{t("forms.provider.pitchBullet2")}</li>
            </ul>
          </div>
        </CardHeader>
        <CardContent>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-2 sm:col-span-2">
                ...
                <Input
                  ...
                  name="website"
                  maxLength={300}
                  placeholder="Portfolio / LinkedIn / Website"
                />
              </div>
            </div>
