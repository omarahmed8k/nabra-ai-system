...
type DialogDirection = "ltr" | "rtl";

function useDialogDirection(dirProp?: React.HTMLAttributes<HTMLElement>["dir"]): DialogDirection {
...
const Dialog = ({ dir, ...props }: DialogProps) => {
  // Direction is resolved in DialogContent; Root doesn't accept `dir`.
  useDialogDirection(dir);
...
>(({ className, children, dir, ...props }, ref) => {
  const direction = useDialogDirection(dir);
  return (
    <DialogPortal>
      <DialogOverlay />
